...
default_weights = {
  "鎧甲": {
    ...
    "詞條2": {
      ...
      "從暗屬性敵人受到的物理傷害減少(%)": 2.0,
      "從念屬性敵人受到的物理傷害減少(%)": 2.0,
      "從不死屬性敵人受到的物理傷害減少(%)": 2.0,
      "從無屬性敵人受到的魔法傷害減少(%)": 2.0,
      "從水屬性敵人受到的魔法傷害減少(%)": 2.0,
      "從地無屬性敵人受到的魔法傷害減少(%)": 2.0,
      "從火無屬性敵人受到的魔法傷害減少(%)": 2.0,
      "從風無屬性敵人受到的魔法傷害減少(%)": 2.0,
      "從毒無屬性敵人受到的魔法傷害減少(%)": 2.0,
      "從聖無屬性敵人受到的魔法傷害減少(%)": 2.0,
      "從暗無屬性敵人受到的魔法傷害減少(%)": 2.0,
      "從念無屬性敵人受到的魔法傷害減少(%)": 2.0,
      "從不死屬性敵人受到的魔法傷害減少(%)": 2.0
    },
    "詞條3": {
      "MaxHP": 0.05,
      "MaxSP": 0.4,
...
if st.button("計算分數"):
    equipment = Equipment.from_raw_input(part, defense=0, trait_inputs=trait_inputs)
